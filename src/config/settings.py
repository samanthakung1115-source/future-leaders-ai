...
class SamanthaSettings:
    ...
    @classmethod
    def load(cls, path: str | Path = "config/samantha_config.json") -> "SamanthaSettings":
        path = Path(path)
        if not path.exists():
            return cls.default()
        ...
        return cls(
            ...
            version=data.get("version", "v11 Beta"),
    ...
    @classmethod
    def default(cls) -> "SamanthaSettings":
        return cls(
