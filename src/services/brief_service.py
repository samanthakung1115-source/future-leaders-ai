...
class BriefService:
    ...
    def build(self, candidates, positions, data_health: dict | None = None) -> SamanthaBrief:
        ...
        return SamanthaBrief(
            ...
            samantha_comment=self._comment(enriched, warnings, data_health or {}),
            data_health=data_health or {},
        )

    def _comment(self, enriched: list[dict], warnings: list[str], data_health: dict) -> str:
